        ...
        <div className="lg:mx-[40px] md:mx-[10px] mx-[10px]">
          <div className="	 lg:flex  lg:gap-x-[100px] md:gap-x-[50px] lg:justify-between md:flex  md:justify-between ">
            ...
            <div className="lg:text-start md:text-start text-center lg:w-2/3 md:w-2/3 lg:mt-[60px] md:mt-[40px] mt-[65px] py-2">
              ...
              Advanced AI algorithms recommend the most relevant suggested jobs at bringin app for job seekers.
              </h1>
              <p className="lg:text-start md:text-start text-center mt-[25px] text-[20px] text-[#212427] ">
              The innovative and secure instant chat-based hiring app offers job seekers the opportunity to send direct messages to recruiters completely free of charge! Bringing never recommends any irrelevant job suggestions to the seekers. AI segregates relevant job recommendations according to the seeker's expertise level and area.

              <p className="pt-6">
              Connect directly with verified recruiters, eliminate the hassle of third parties or intermediaries, and find your dream job with full privacy protection.
              </p>
              </p>
            ...
            <div className="lg:mt-[350px] mt-[50px] md:mt-[60px] ">
          <RFaq></RFaq>
        </div>
        </div>
