import s from '../../../assets/recruiters/Group 11952.svg'
...
const Streamline = () => {
  return (
    ...
    <div className="lg:h-[550px] md:h-[360px] h-[480px] bg-[#E6F1F8] lg:px-10 p-3">
      <div className="flex gap-5 justify-between">
        <div className=" hidden lg:block md:hidden ">
          ...
          src={s} className="lg:w-[359px] lg:h-[484px] lg:mt-[55px] mt-[2px]"></img>
        </div>
        <div className="lg:w-2/3  lg:text-start md:text-center text-center">
          <div className="lg:mt-[50px] mt-[20px] mr-4 0">
            <h1 className="lg:text-[42px] md:text-[35px] text-[30px] font-semibold text-black  ">
              Streamline Your Recruitment Process with <span className="text-[#0077B5]">Bringin</span> the AI-Powered
              Hiring App that Makes Finding Top Talents a Breeze.
              <p className="lg:text-[42px] md:text-[35px] text-[30px] font-semibold lg:mt-[100px] lg:mt-10 md:mt-5 mt-2 text-black">
                Download the <span className="text-[#0077B5]">Bringin</span> App Now.{" "}
              </p>
            </h1>
            <div className="card-actions lg:justify-start md:justify-center justify-center lg:mt-10 md:mt-5 mt-3">
            <>


              <label htmlFor="my-modal-8" className="lg:w-[220px] cursor-pointer md:w-[120px] w-[120px] lg:h-[60px] md:h-[50px] h-[40px]  bg-[#0077B5] shadow-sm rounded lg:text-[20px] md:text-[18] text-[18px] lg:font-semibold md:font-semibold text-white px-2">
                <p className="text-center lg:py-4 md:py-3 py-2">Download</p>
              </label>
            </>
            </div>
          </div>
