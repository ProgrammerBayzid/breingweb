          ...
          <div className="mt-7">
            ...
            <div className="mb-7">
              <p className="font-semibold text-[21px]">
                2. Third-Party Links and Accounts
              </p>
              <p className="text-[#6A6A6A] text-[21px] font-medium">
                Our website or mobile app may contain links, websites or social
                media accounts of the users. Which are not owned by us. So we do
                not take any responsibility for any third party sites which is
                provided by its users. Therefore, use or access those links or
            ...
            <div className="mb-7">
              ...
              <p className="text-[#6A6A6A] text-[21px] font-medium">
                ...
                suffers as a result of any false information you provide.
                Moreover, you will bear the confidentiality of all your
                information.
              </p>
            </div>
            <div className="mb-7">
              <span className="font-semibold text-[21px]">
                B) Job Seeker Account:{" "}
              </span>
              <p className="text-[#6A6A6A] text-[21px] font-medium">
            ...
            <div className="mb-7">
              <div className="font-semibold text-[21px] mb-7">
              ...
              <p className="mb-7 text-[#6A6A6A] text-[21px] font-medium">
                D) You shall not post/upload/transmit/share any contents that is
                unlawful, discriminatory, fraudulent, harassing, fake, Spam,
                scam, infringing, etc.
              </p>
            </div>
            ...
            <div className="mb-7">
              ...
              <p className="mb-7 text-[#6A6A6A] text-[21px] font-medium">
                ...
                Anyone can also report for spam, scam, fraud, or etc.
              </p>
            </div>
            ...
            <p className="mb-4 text-[#6A6A6A] text-[21px] font-medium">
              {" "}
            ...
            <p className="mb-4 text-[#6A6A6A] text-[21px] font-medium">
              {" "}
              C) Communicate with you about your account and the Service.{" "}
            </p>
            <p className="mb-4 text-[#6A6A6A] text-[21px] font-medium">
              {" "}
            ...
            <p className="mb-4 text-[#6A6A6A] text-[21px] font-medium">
              {" "}
              E) Improve and personalize the Service.{" "}
            </p>
            <p className="mb-4 text-[#6A6A6A] text-[21px] font-medium">
              {" "}
            ...
            <p className="mb-4 text-[#6A6A6A] text-[21px] font-medium">
              We take the protection of your personal data seriously and have
              implemented appropriate technical and organizational measures to
              ensure its security. We will only retain your personal data for as
              long as necessary to fulfill the purposes for which it was
              collected or as required by law. You have the right to request
              access to, rectification or deletion of your personal data, as
              well as the right to object to and restrict its processing. If you
              have any questions or concerns about our use of your personal
            ...
            <div className="mb-4">
              ...
              <p className="mb-7 text-[#6A6A6A] text-[21px] font-medium">
                ...
                data and will implement and maintain appropriate technical and
                organizational measures to ensure a level of security to protect
                your data secured from accidental or unauthorized destruction,
            ...
            <div className="mb-7">
              ...
              <p className="text-[#6A6A6A] text-[21px] font-medium">
                ...
                day trial for 12 chat initiations. After that, they will
                upgraded to a Freemium plan of 04 free chats a day.
              </p>
            ...
            <div className="mb-7">
              ...
              <p className="text-[#6A6A6A] text-[21px] font-medium">
              We may terminate or suspend your account, without prior notice or liability, for any reason, including limitation if you breach the terms.
              </p>
              <p className=" text-[#6A6A6A] text-[21px] font-medium">
                Recruiters can choose between the different plan options to
                connect with more candidates on Unbolt. Payments are made
