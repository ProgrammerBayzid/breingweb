  ...
  return (
    <div>
      ...
      <div className="flex font-inter ">
        <div className="">
          <div className="lg:w-[675px] lg:h-auto md:w-[675px] md:h-auto w-full px-7 py-2  rounded rounded-[10px]   px-4  mx-1 bg-[#FCFCFC]">
            ...
            <div className="lg:mt-[20px] mt-[25px] ">
                  ...
                  <div>
                    {job_status === "Open" ? (
                      <div className="flex gap-x-2">
                        ...
                        <p className="text-[#0077B5] text-[18px] font-semibold">
                          Active
                        </p>
                      </div>
                    ) : (
                    ...
                    <p className="text-[#000000] text-[16px] font-normal text-opacity-60 mt-[2px]">
              ...
              <div className="lg:mt-[20px] mt-[12px]">
                {job_description ? (
                  <p className="text-[16px] text-[#212427] text-opacity-80 font-medium" dangerouslySetInnerHTML={{ __html: html }}>
              ...
              <div>
                <div className="">
                  <Link to={`/dashboard/recruiter/job-details-edit/${_id}`}>
                    <button
                      type="button"
