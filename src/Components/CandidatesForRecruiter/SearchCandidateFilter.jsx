...
// const SearchCandidateFilter = ({
//   setFilterCandidateModals,
//   setItems,
//   result,
//   setResultsFound,
...
//     reset();
//     setTimeout(() => {
//       setFilterCandidateModals(false);
...
//           <button
//             onClick={reset}
//             className="text-[#00A0DC] border border-1 border-[#00A0DC] px-1 rounded-lg"
//           >
//             Reset
//           </button>
//         </div>
//         <div className="mb-3  text-[14px] px-8 flex items-center flex-wrap gap-x-[20px] gap-y-[10px] ">
//           <button
//             onClick={jobtypeAll}
//             className={
//               activeButtonjt === true
//                 ? "border border-1 border-[#00A0DC] rounded-xl w-[100px] h-[30px]  bg-[#00A0DC] bg-opacity-5"
//                 : " border border-1 border-[#00A0DC] rounded-xl w-[100px] h-[30px] "
//             }
//           >
//             All
//           </button>
...
//           )}
//         </div>
//         <h1 className="font-semibold ms-8 pb-4 mt-5">Required Education</h1>
//         <div className="mx-4 pb-3 text-[14px]">
//           <button
//             onClick={educationAll}
//             className={
//               activeButtoned === true
//                 ? "border border-1 border-[#00A0DC] rounded-xl w-[158px] h-[40px] mx-4 2 me-4 mb-3 bg-[#00A0DC] bg-opacity-5"
//                 : "border border-1 border-[#00A0DC] rounded-xl w-[158px] h-[40px] mx-4 2 me-4 mb-3 "
//             }
//           >
//             All
//           </button>
...
//                       ? "border border-1 border-[#00A0DC] rounded-xl w-[158px] h-[40px] mx-4  me-4 bg-[#00A0DC] bg-opacity-5"
//                       : "border border-1 border-[#00A0DC] rounded-xl w-[158px] h-[40px] mx-4  me-4"
//                   }
//                 >
//                   {edu?.name}
//                 </button>
...
//           )}
//         </div>
//         <h1 className="font-semibold ms-8 mt-3">Offered Salary (Monthly)</h1>
//         <div className="m-4 text-[14px]">
//           <button
//             onClick={salaryAll}
//             className={
//               activeButtons === true
//                 ? "border border-1 border-[#00A0DC] rounded-xl w-[158px] h-[40px] mx-4 0 me-4 bg-[#00A0DC] bg-opacity-5"
//                 : "border border-1 border-[#00A0DC] rounded-xl w-[158px] h-[40px] mx-4 0 me-4 "
//             }
//           >
//             All
//           </button>
...
//                 ? "border border-1 border-[#00A0DC] rounded-xl w-[158px] h-[40px] mb-2 mx-4  bg-[#00A0DC] bg-opacity-5"
//                 : "border border-1 border-[#00A0DC] rounded-xl w-[158px] h-[40px] mb-2 mx-4 "
//             }
//           >
//             Negotiable
//           </button>
...
//                 ? "border border-1 border-[#00A0DC] rounded-xl w-[158px] h-[40px] mx-4  bg-[#00A0DC] bg-opacity-5"
//                 : "border border-1 border-[#00A0DC] rounded-xl w-[158px] h-[40px] mx-4 "
//             }
//           >
//             280K-320K BDT
//           </button>
...
//                       ? "border border-1 border-[#00A0DC] rounded-xl w-[158px] h-[40px] my-1 mx-4 bg-[#00A0DC] bg-opacity-5"
//                       : "border border-1 border-[#00A0DC] rounded-xl w-[158px] h-[40px] my-1 mx-4 "
//                   }
//                 >
//                   {ex?.name}
//                 </button>
...
//         <div className="mx-4 text-[14px] flex items-center flex-wrap gap-x-[20px] gap-y-[10px] px-4">
//           <button
//             onClick={industryAll}
//             className={
//               activeButtonId === true
//                 ? "border border-1 border-[#00A0DC] rounded-xl w-[100px] h-[40px]  bg-[#00A0DC] bg-opacity-5"
//                 : "border border-1 border-[#00A0DC] rounded-xl w-[100px] h-[40px] "
//             }
//           >
//             Any Industry
//           </button>
...
//                       ? "border border-1 border-[#00A0DC] rounded-xl px-[10px] h-[40px] "
//                       : "border border-1 border-[#00A0DC] rounded-xl px-[10px] h-[40px] bg-[#00A0DC] bg-opacity-5"
//                   }
//                 >
//                   {ind?.industryname}
//                 </button>
...
//           <button
//             onClick={() => setFilterCandidateModals(false)}
//             className="btn bg-[#0077B5] md:w-[640px] h-[48px] md:mx-auto rounded-lg text-white text-[18px]"
//           >
//             Apply
//           </button>
//         </div>
...
// export default SearchCandidateFilter;
import { useEffect, useState } from "react";
