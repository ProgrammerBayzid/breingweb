...
const RecruterSearchSingalCandidate = ({ cl }) => {
      ...
      <div className="font-inter ps-6 ">
              ...
              <div className="font-inter flex gap-x-3">
                ...
                <div className="font-inter group flex ">
                  ...
                  <p className="font-inter  ">
                    {edu?.digree?.name ? (
                      <li className="font-inter ms-2 text-[15px] text-[#212427] text-opacity-80">{edu?.digree?.name}</li>
                    ) : (
                      ""
                    )}{" "}
                  </p>
          ...
          <div className="font-inter flex mt-[5px] ">
            ...
            <div className="font-inter flex items-center mt-[5px]">
              ...
              <div>
                <Link
                  to={`/dashboard/recruiter/details-of-candidate/${cl?._id}`}
                >
                  <img
...
export default RecruterSearchSingalCandidate;
