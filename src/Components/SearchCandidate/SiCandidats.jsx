...
const SiCandidats = ({ singlecanditade }) => {
...
// edu 
 ...
 var eduEndYear = Emonth + " " + Eyear;
  ...
  return (
    <div>
      <div className="lg:w-[845px] lg:py-[30px] shadow-[rgba(17,_17,_26,_0.1)_0px_0px_16px] lg:px-7 lg:py-7 p-2 mb-10 bg-white w-[330px] rounded">
        <div className="lg:flex gap-x-5">
            ...
            <div className="ml-[5px]">
              ...
              <div className="block lg:hidden ">
                <div className="flex gap-3 mt-[7px]">
                  {edu ? (
                    <div className="rounded rounded-[20px] border border-[#5C6565]  h-[22px] flex items-center">
                      <div>
                        <p className="px-[4px]  text-[#5C6565] text-[10px]">
                  ...
                  {userid?.experiencedlevel?.name ? (
                    <div className="  rounded rounded-[20px] border border-[#5C6565]  h-[22px] flex items-center ">
                      <p className="px-[4px]  text-[#5C6565] text-[10px] mx-[2px]">
                        {userid?.experiencedlevel?.name
                          ? userid?.experiencedlevel?.name
                          : ""}
                      </p>
          ...
          <div>
            ...
            <div className="hidden lg:block">
              <div className="flex gap-3 mt-[7px]">
                {edu ? (
                  <div className="rounded rounded-[20px] border border-[#5C6565] h-[29px] flex items-center">
                    <div>
                      <p className="px-2 text-[#5C6565] text-[13px] ">
                        {edu?.digree?.name ? edu?.digree?.name : ""}
                      </p>
                    </div>
                  </div>
            ...
            <div className=" lg:flex ">
                      ...
                      <div className="">
                        {workexperience?.map((w) => (
                          <div key={w._id}>
                            ...
                            <p className="text-[#5C6565]  text-[14px]">
              ...
              <div>
                <div className="lg:ml-0 flex gap-2 lg:mt-[30px]  h-[47px]">
                  <div className="flex gap-x-2">
                    <div>
                         <LazyLoadImage
              effect= "blur"
            ...
            <div className=" lg:flex 	 ">
              <div>
                <div className="w-[300px]">
                  {first?.division?.divisionname ? (
                    <div className=" flex gap-2 items-center lg:mt-[25px] ">
                      <div>
                        {" "}
                           <LazyLoadImage
              effect= "blur"
              ...
              <div>
                <div className=" lg:mt-[25px] mt-[5px] ml-7  lg:ml-0 ">
