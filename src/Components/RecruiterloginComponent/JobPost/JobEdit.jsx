  ...
  const onSubmit = async (e) => {
      ...
      job_location: {
        ...
        lon:
          selectedLocation === null
            ...
            : null,
        formet_address:
          locationName === "" ? job_location?.formet_address : locationName,
        locationoptional:
          locationoptional === ""
    ...
    try {
      ...
      const response = await fetch(
        `https://rsapp.unbolt.co/job_post_update?jobid=${jobdetails?._id}`,
        {
          method: "POST",
          headers: {
              ...
              <div>
                <div>
                  ...
                  <div className="mt-5">
                    ...
                    <div className="w-full flex flex-wrap gap-3 mt-2"></div>
